...
export const NotificationHeader: React.FC<Props> = ({ notifications, onCompose }) => {
  ...
  const cards = [
    { label: 'Total Sent', value: stats.totalSent, icon: Send, color: 'text-[#1CB0F6]', bg: 'bg-[#1CB0F6]/10' },
    { label: 'Open Rate', value: `${stats.openRate}%`, icon: Eye, color: 'text-[#58CC02]', bg: 'bg-[#58CC02]/10' },
    { label: 'Active Campaigns', value: stats.active, icon: Megaphone, color: 'text-[#CE82FF]', bg: 'bg-[#CE82FF]/10' },
    { label: 'Scheduled', value: stats.scheduled, icon: Clock, color: 'text-[#FFC800]', bg: 'bg-[#FFC800]/10' },
  ];
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Track your school-wide notification performance</p>
        </div>
